...
* Concrete form, which can be:
    ...
    * Digital: digitised version of a physical document nor native digital source such as database, archive inventory...;
    * Derived: version obtained after an automatic or manual processing (e.g., georeferenced map, transcription...) of a physical/digital source. There may be several derived forms of the same source.
...
* {*mandatory*} its **title**;
* {*mandatory*} its **type** (e.g., cadastral index map, assembly map of cadastral index maps, initial register, mutation register, folio, geographic database...)
